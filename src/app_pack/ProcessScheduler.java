...
public class ProcessScheduler
{
	...
	public void HPFSP()
	{
		...
		{
			// the process will not finish
			if (running_process.currentruntime + newtimequantum < running_process.expectedruntime)
			{
				current_time += newtimequantum;
				running_process.currentruntime += newtimequantum;
